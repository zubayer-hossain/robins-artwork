                    ...
                    <div className="flex justify-between h-16">
                        <div className="flex items-center">
                            ...
                            <div className="hidden md:ml-8 md:flex md:space-x-8">
                                ...
                                <NavLink href={route('orders')} active={route().current('orders') || route().current('orders.*')}>
                                    Orders
                                </NavLink>
                ...
                {showingNavigationDropdown && (
                    <div className="md:hidden">
                        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t border-gray-200 animate-in slide-in-from-top-2 duration-200">
                            ...
                            <MobileNavLink href={route('orders')} active={route().current('orders') || route().current('orders.*')}>
                                Orders
                            </MobileNavLink>
