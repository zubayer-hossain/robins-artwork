...
export default function AdminUsersCreate({ auth, roles = [], flash }) {
    ...
    return (
        <AdminLayout
            ...
            headerDescription="Add a new user with name, email, password and role"
            headerActions={
                            ...
                            <div className="lg:col-span-2 space-y-6">
                                <Card className="border-0 shadow-sm">
                                    <CardHeader className="bg-gray-50/50 border-b">
                                        ...
                                        <p className="text-sm text-gray-500 mt-1">Create a user account. They can log in with this email and password.</p>
                                    </CardHeader>
