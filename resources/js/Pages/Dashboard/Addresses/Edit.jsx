...
export default function AddressEdit({ address }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(route('addresses.update', address.id), {
                method: 'PUT',
                headers: {
            ...
            if (data.success) {
                window.toast?.success('Address updated successfully', 'Address Updated');
                router.visit(route('addresses.index'));
            } else {
                window.toast?.error(data.message || 'Failed to update address', 'Error');
            }
        } catch (error) {
                ...
                <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600 mt-1">Update your address information</p>
                        </div>
                    </div>
